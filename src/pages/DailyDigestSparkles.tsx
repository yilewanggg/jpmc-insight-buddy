...
import logoSparkles from "@/assets/logo-option-sparkles.png";
...
function SparklesWelcome() {
  ...
  return (
    <div className="flex items-start pt-[210px] mx-auto" style={{ width: '740px' }}>
      <motion.div
        className="w-12 h-12 rounded-2xl flex items-start justify-center mr-1 -mt-1 shrink-0"
      ...
      >
        <div className="relative w-10 h-10 flex items-center justify-center overflow-hidden rounded-full">
          <img src={logoSparkles} alt="Assistant" className="w-8 h-8 relative z-10 object-contain" loading="lazy" />
...
export default DailyDigestSparkles;
